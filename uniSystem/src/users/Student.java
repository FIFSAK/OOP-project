//<<<<<<< HEAD
	...
	public class Student extends User implements Serializable{
	    ...
	    private Vector<StudentOrganisation> studentOrganization = new Vector<StudentOrganisation>();
	    ...
	    public void createOrganisation(StudentOrganisation organisation) {
	        this.studentOrganization.add(organisation);
	        organisation.setHead(this);
	        Data.getInstance().addStudentOrganizationDatabase(organisation);
	    }
	    ...
	    public Vector<StudentOrganisation> getStudentOrganization() {
	    ...
	    public void saddStudentOrganization(StudentOrganisation studentOrganization) {
	        this.studentOrganization.add(studentOrganization);
	    }
	...
	//    }
	    ...
	    public void joinStudentOrganization(StudentOrganisation organization) {
	        this.studentOrganization.add(organization);
	    }
	    ...
	    public void leaveStudentOrganization(StudentOrganisation organization) {
	        if (studentOrganization != null) {
	            studentOrganization.remove(organization);
	        }
	    }
...
//    }
//}
//>>>>>>> a2938a2d6c3d11c905143234d56e684bb8a3f509
